...
def execute(self, inputs, outputs, gvm):
    ...
    try:
        #endf = rospy.ServiceProxy('/image_front/end', std_srvs.srv.Empty)
	    #endf()
	    endl = rospy.ServiceProxy('/left_saver/end', std_srvs.srv.Empty)
	    endl()
	    endr = rospy.ServiceProxy('/right_saver/end', std_srvs.srv.Empty)
	    endr()
